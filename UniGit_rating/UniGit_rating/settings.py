"""
Django settings for UniGit_rating project.
...
SECRET_KEY = 'django-insecure-!rtu%1i3n2)k5%q#758+krxe)tt(t1l&)z8-+a9*84r$)jub2^'
...
WSGI_APPLICATION = 'UniGit_rating.wsgi.application'
